...
RUN echo "ln -sf /python/3.10/bin/python3 /usr/local/bin/python" >> /usr/local/bin/npm
RUN echo "ln -sf /python/3.10/bin/python3 /usr/local/bin/python3" >> /usr/local/bin/npm
RUN echo "export PATH=/python3.10/bin/:$PATH" >> /usr/local/bin/npm
